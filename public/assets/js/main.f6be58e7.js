                            ...
                            try {
                                ...
                                try {
                                    200 ===
                                        (
                                            await Qe.post(
                                                "https://ranayas.com/api/stored-test",
                                                t
                                            )
                                        ).status
                                    sessionStorage.setItem("test_question", 'submitted');
                                    window.location.href = 'https://ranayas.com';
                                } catch (n) {
