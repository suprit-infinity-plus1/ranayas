                ...
                <div class="row ptb--40 ptb-md--30 ptb-sm--20">
                    <div class="col-lg-12  col-md-12 order-md-2 mb-sm--25">
                        <div class="about-text">
                            ...
                            <p class="color--light-3 text-secondary lh-base mt-2">This page states the Terms and Conditions
                                under which you (Visitor)
                            ...
                            <h2 class="text-left mb-1 mt-3 fs-3 fw-normal">Use Of Content</h2>
                            <p class="color--light-3 text-secondary lh-base">All logos, brands, marks headings, labels,
                                names, signatures,
                            ...
                            <p class="color--light-3 text-secondary lh-base mt-2">You may not sell or modify the content of
                                this Website or reproduce,
                                display, publicly
                            ...
                            <h2 class="text-left mb-1 mt-3 fs-3 fw-normal">Acceptable Website Use</h2>
                            <ul>
                                <li>
                                    <h2 class="text-left mb-1 mt-3 fs-3 fw-normal">(A) Security Rules</h2>
                                    <p class="text-secondary lh-base">Visitors are prohibited from violating or
                                        attempting to violate the security of the Web site, including, without limitation,
                                        (1)
                                        accessing data not intended for such user or logging into a server or account which
                                        the
                                        ...
                                        measures
                                        without proper authorisation, (3) attempting to interfere with service to any user,
                                        host
                                        or network, including, without limitation, via means of submitting a virus or
                                        "Trojan
                                        ...
                                        products
                                        or services. Violations of system or network security may result in civil or
                                        criminal
                                        liability. The business and / or its associate entities will have the right to
                                        investigate occurrences that they suspect as involving such violations and will have
                                        the
                                        right to involve, and cooperate with, law enforcement authorities in prosecuting
                                        users
                                        who are involved in such violations.</p>
                                </li>
                                <li>
                                    <h2 class="text-left mb-1 mt-3 fs-3 fw-normal">(B) General Rules</h2>
                                    <p class="text-secondary lh-base">Visitors may not use the Web Site in order to
                                        transmit, distribute, store or destroy material (a) that could constitute or
                                        encourage
                                        conduct that would be considered a criminal offence or violate any applicable law or
                                        regulation, (b) in a manner that will infringe the copyright, trademark, trade
                                        secret or
                                        ...
                                        profane, obscene, threatening, abusive or hateful.</p>
                                </li>
                            </ul>
                            ...
                            <h2 class="text-left mb-1 mt-3 fs-3 fw-normal">Indemnity</h2>
                            <p class="color--light-3 text-secondary lh-base">The User unilaterally agree to indemnify and
                            ...
                            <p class="color--light-3 text-secondary lh-base">User further agrees that Company shall not be
                            ...
                            <p class="color--light-3 text-secondary lh-base">User agrees that Company shall not be
                                responsible or liable to user,
                                or anyone, for the
