...
<section class="faqs-sec py-5 bg-light">
    ...
    <div class="faqs-wrapper d-flex flex-row align-items-stretch gap-3">
        <div class="col col-1">
            <figure>
                <img src="assets/image/expressive-bearded-man-orange-tshirt.jpg" alt="frequently asked question image" width="100%">
            </figure>
        </div>
        <div class="col col-2">
            <ul class="facs-accordion">
                <li class="acc-tab border-bottom border-light-subtle"><input class="d-none" type="radio" name="acc-tab" id="acc-tab-1">
                ...
                <li class="acc-tab border-bottom border-light-subtle"><input class="d-none" type="radio" name="acc-tab" id="acc-tab-2">
                ...
                <li class="acc-tab border-bottom border-light-subtle"><input class="d-none" type="radio" name="acc-tab" id="acc-tab-3">
                ...
                <li class="acc-tab border-bottom border-light-subtle"><input class="d-none" type="radio" name="acc-tab" id="acc-tab-4">
                ...
                <li class="acc-tab border-bottom border-light-subtle"><input class="d-none" type="radio" name="acc-tab" id="acc-tab-5">
                    ...
                    <div class="acc-content overflow-hidden">
                        <p class="fs-6 py-1 px-2">Vibe isn’t designed to help with tinnitus. Please email <a href="mailto:easyfithearing@gmail.com">easyfithearing@gmail.com</a> or contact our
                            customer service team and we’ll refer you to some options for tinnitus help.</p>
                    </div>
                </li>
                <li class="acc-tab border-bottom border-light-subtle"><input class="d-none" type="radio" name="acc-tab" id="acc-tab-6">
                ...
                <li class="acc-tab border-bottom border-light-subtle"><input class="d-none" type="radio" name="acc-tab" id="acc-tab-7">
