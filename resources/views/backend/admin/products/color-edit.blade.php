    ...
    <div class="modal" id="addImageModal">
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                ...
                <form action="{{ route('admin.products.add.images', $product->id) }}" method="POST"
                    class="needs-validation" enctype="multipart/form-data" id="formAddImage">
                    @csrf
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" name="stock" class="form-control" id="stock"
                                    placeholder="Enter Stock" value="{{ $cl->stock }}" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="gallery gallery-md">
                                @foreach ($images as $key => $img)
                                    <div class="item">
                                        <div class="gallery-item" data-image="{!! asset('storage/images/multi-products/' . $img->image_url) !!}"
